...
x_train_2,x_test_2 = get_data(data,feature1,50000)
x_train_3,x_test_3 = get_data(data,feature2,50000)
x_train_4,x_test_4 = get_data(data,feature2,50000)
x_train_5,x_test_5 = get_data(data,feature3,50000)
x_train_6,x_test_6 = get_data(data,feature3,50000)
